...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt-br">
	<head>
		...
		$strColunasTabela = "id,nome,login,senha,telefone";
		...
		<div>
			...
			<div class="tdGerenciar">
				<table id="tbGerenciar">
					<tr>
						<th><a href="index.php?pagina=<?=$intPaginaAtual?>&amp;ordenacao=0&amp;ordem=<?=$intOrdem?>">ID</a></th>
						<th><a href="index.php?pagina=<?=$intPaginaAtual?>&amp;ordenacao=1&amp;ordem=<?=$intOrdem?>">Nome</a></th>
						<th><a href="index.php?pagina=<?=$intPaginaAtual?>&amp;ordenacao=2&amp;ordem=<?=$intOrdem?>">Telefone</a></th>
					...
					<tr>
						<td><?= $resultRow['id']?></td>
						<td><a href="visualizarPadrao.php?id=<?= $resultRow['id']?>"><?= $resultRow['nome']?></a></td>
						<td><?= $resultRow['telefone']?></td>
						<td ><a class="alterarGerenciar" href="alterarPadrao.php?id=<?= $resultRow['id']?>"><span class="fig">alterar</span></a></td>
						<td ><a class="excluirGerenciar" href="excluirPadrao.php?id=<?= $resultRow['id']?>" onclick="javascript: return confirm('Deseja realmente excluir esse usuario??')"><span class="fig">excluir</span></a></td>
					</tr>
					<?
					}?>
				</table>
			...
			<div class="Paginacao">
				<span>
					<?if($intPaginaAtual > 1){
					?>
						<big><a class="um" href="index.php?pagina=1&amp;ordenacao=<?=$intOrdemAtual?>&amp;tipo=<?=$intTipoAtual?>&amp;ordem=<?=abs($intOrdem-1)?>">Primeira</a></big>
						||
						<big><a class="dois" href="index.php?pagina=<?=$intAnteriorPagina?>&amp;ordenacao=<?=$intOrdemAtual?>&amp;tipo=<?=$intTipoAtual?>&amp;ordem=<?=abs($intOrdem-1)?>"><<</a></big>
						||
					<?}
					...
					?>
						||
						<big><a class="tres" href="index.php?pagina=<?=$intProximaPagina?>&amp;ordenacao=<?=$intOrdemAtual?>&amp;tipo=<?=$intTipoAtual?>&amp;ordem=<?=abs($intOrdem-1)?>">>>	</a></big>
						||
						<big><a class="quatro" href="index.php?pagina=<?=$intPaginas?>&amp;ordenacao=<?=$intOrdemAtual?>&amp;tipo=<?=$intTipoAtual?>&amp;ordem=<?=abs($intOrdem-1)?>">Ultima</a></big>
					<?
					}?>
