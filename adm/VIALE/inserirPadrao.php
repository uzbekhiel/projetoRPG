...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt-br">
	<head>
		...
		===============================================================================*/
		 ...
		 //Inicialização de Variáveis
			...
			//Texto exibido de quando der certo a inserção no banco
			$strSucesso = "";
			
			//Texto exibido de quando der erro na validação
			$strErro = "Existem campos não preenchidos ou preenchidos incorretamente";
	...
	<?
		if($_POST)
		{	
			//vai retornar um vetor, cujos indices saum numeros, começando por 0, e indo até o número de campos.
...
<body>
		...
		?>
        	<h2>Inserir Padrão</h2>

				<? imprimeSESSION(); ?>
				<div class="inseAlt">
					<form method="post" action="">
						<fieldset>
							<legend>Inserir Padrão</legend>
							<div class="multi">
